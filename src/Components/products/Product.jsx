    ...
    if (selectedProductId) {
      try {
        const response = await axios.delete(
          `http://localhost:8000/api/deleteproduct/${selectedProductId}`
        );
...
//                 <Link
//                   className="text-white bg-sky-500 hover:bg-sky-700 shadow-lg shadow-black ml-20
//          focus:outline-none focus:ring-sky-300 font-medium rounded-lg
